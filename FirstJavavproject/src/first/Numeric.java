...
public class Numeric {
	public static void main(String[] args) {
       ...
       //character
        ...
        System.out.println("Minimum double value: " +(int) cmax );
        System.out.println("Maximum double value: " + (int)cmin );
      //boolean
        boolean bmax = Boolean.TRUE;
        boolean bmin = Boolean.FALSE;
        System.out.println("Minimum double value: " + bmax );
        System.out.println("Maximum double value: " + bmin );
